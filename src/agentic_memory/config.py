...
class AgentConfig:
    ...
    observer_velocity_threshold: int = 8
    observer_velocity_window: int = 900
    observer_idle_sweep: int = 180
    observer_cooldown: int = 300
...
def load_config(path: str = "config.yaml") -> Config:
    ...
    return Config(
        ...
        agents=AgentConfig(
            ...
            observer_velocity_threshold=observer.get("velocity_threshold", 8),
            observer_velocity_window=observer.get("velocity_window", 900),
            observer_idle_sweep=observer.get("idle_sweep_seconds", 180),
            observer_cooldown=observer.get("cooldown_seconds", 300),
